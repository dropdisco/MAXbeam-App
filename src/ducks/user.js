...
const USER_LOG_IN = 'MAXbeam/user/USER_LOG_IN';
...
const USER_LOG_OUT = 'MAXbeam/user/USER_LOG_OUT';
...
const FETCH_LOGIN_DATA_REQUEST = 'MAXbeam/user/FETCH_LOGIN_DATA_REQUEST';
...
const FETCH_LOGIN_DATA_SUCCESS = 'MAXbeam/user/FETCH_LOGIN_DATA_SUCCESS';
...
const FETCH_LOGIN_DATA_FAILURE = 'MAXbeam/user/FETCH_LOGIN_DATA_FAILURE';
...
const fetchLoginData = () => async (dispatch) => {
  ...
  try {
    ...
    if (typeof res !== 'undefined') {
      ...
      dispatch(fetchLoginDataFailure(`Login data doesn't exist.`));
    }
  } catch (e) {
...
const SAVE_LOGIN_DATA_REQUEST = 'MAXbeam/user/SAVE_LOGIN_DATA_REQUEST';
...
const SAVE_LOGIN_DATA_SUCCESS = 'MAXbeam/user/SAVE_LOGIN_DATA_SUCCESS';
...
const SAVE_LOGIN_DATA_FAILURE = 'MAXbeam/user/SAVE_LOGIN_DATA_FAILURE';
